...
public class RadzenButtonLocalized : RadzenButton
{
    [Inject] RadzenLocalizer L { get; set; }
    protected override void OnInitialized()
    {
      BusyText = L["RadzenButton.BusyText"] ?? BusyText;
        base.OnInitialized();
    }
}

public class RadzenCheckBoxListLocalized<TValue> : RadzenCheckBoxList<TValue>
{
    [Inject] RadzenLocalizer L { get; set; }
    protected override void OnInitialized()
    {
      SelectAllText = L["RadzenCheckBoxList.SelectAllText"] ?? SelectAllText;
        base.OnInitialized();
    }
}
...
public class RadzenDropDownLocalized<TValue> : RadzenDropDown<TValue>
{
    ...
    protected override void OnInitialized()
    {
      ...
      SelectAllText = L["RadzenDropDown.SelectAllText"] ?? SelectAllText;
        base.OnInitialized();
    }
}
...
public class RadzenDropDownDataGridLocalized<TValue> : RadzenDropDownDataGrid<TValue>
{
    ...
    protected override void OnInitialized()
    {
      ...
      SearchText = L["RadzenDropDownDataGrid.SearchText"] ?? SearchText;
